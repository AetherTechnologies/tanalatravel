...
$sql="INSERT INTO tbllocation(loc_type,loc_name,loc_long,loc_lat,loc_price,loc_status,loc_image) VALUES(:loctype,:locname,:loclongitude,:loclatitude,:locprice,:locstatus,:locimage)";
