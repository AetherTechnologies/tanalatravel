...
<form method="POST">
<section class="profile bg0 p-t-23 p-b-130">
	<div class="container">
		<div class="p-b-10">
...
?>
						...
						<!-- Password -->	
							<div class="bor8 m-b-20 how-pos4-parent">
								<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="password" placeholder="Password" maxlength = "30" value="<?php echo $p4; ?>" required>
							</div>		
						...
						<!-- Email -->	
							...
							<a href="editprofile.php" class="flex-c-m stext-101 cl0 size-121 bg3 bor1 hov-btn3 p-lr-15 trans-04 pointer">
								Edit profile
							</a>
						<br>
