		...
		<div class="container">
			<div class="flex-w flex-sb-m p-b-52">
				<div class="flex-w flex-l-m filter-tope-group m-tb-10">
					<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5 how-active1" data-filter=".Onepiece">
						Onepiece Products
					</button>					
				</div>				
			</div>
...
<?php
include('bridge.php');
$query2 = "SELECT * from product where product_type = 'onepiece' and product_status = 'Active'";
